...
public class RestoMaterial implements Serializable {
    ...
    public RestoMaterial(String nombre, String epoca, String tipologia, Museo museo) {
        this.nombre = nombre;
        this.epoca = epoca;
        this.tipologia = tipologia;
        this.museo = museo;
